    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PortalLinkMaster>().HasData(
                new PortalLinkMaster { Id = 1, Title = "NEW APPLICATION", Section = "ADMISSION_LINK", LinkType = "INTERNAL_ROUTE", TargetUrl = "/register", Description = "Register a new student for Academic Year 2026–2027", DisplayOrder = 1, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 2, Title = "Notice to Parents", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/notice_to_parents.pdf", Description = "Important announcements and eligibility criteria", DisplayOrder = 2, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 3, Title = "Indian Schools Websites", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/indian_schools_websites.pdf", Description = "Directory & links of all Indian Schools in Oman", DisplayOrder = 3, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 4, Title = "FAQ", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/faq.pdf", Description = "Find answers regarding admission procedures", DisplayOrder = 4, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 5, Title = "Languages offered in Schools", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/languages_offered.pdf", Description = "Overview of 2nd & 3rd languages available per school", DisplayOrder = 5, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 6, Title = "Inter-School Transfer", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/inter_school_transfer.pdf", Description = "Transfer guidelines between Indian schools in Oman", DisplayOrder = 6, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 7, Title = "Admissions to Other Nationalities", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/admissions_other_nationalities.pdf", Description = "Registration guidelines for non-Indian passport holders", DisplayOrder = 7, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 8, Title = "Projected Vacancies", Section = "ADMISSION_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/projected_vacancies.pdf", Description = "Check seat availability across all classes & schools", DisplayOrder = 8, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 9, Title = "Product Description", Section = "FOOTER_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/annexure_a.pdf", Description = "Portal product description", DisplayOrder = 1, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 10, Title = "Privacy Policy", Section = "FOOTER_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/notice_to_parents.pdf", Description = "Privacy policy details", DisplayOrder = 2, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 11, Title = "Delivery Policy", Section = "FOOTER_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/annexure_a.pdf", Description = "Delivery terms and policy", DisplayOrder = 3, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate },
                new PortalLinkMaster { Id = 12, Title = "ContactUS", Section = "FOOTER_LINK", LinkType = "PDF_DOCUMENT", TargetUrl = "assets/docs/indian_schools_websites.pdf", Description = "Contact details and helpdesk information", DisplayOrder = 4, IsActive = true, IsDeleted = false, OpenInNewTab = false, CreatedAt = seedDate }
            );

            // Seed Capital Area Indian Schools Master
            modelBuilder.Entity<PortalSchoolMaster>().HasData(
                new PortalSchoolMaster { Id = 1, SlNo = 1, Name = "Indian School Muscat", Code = "ISM", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Darsait / Muscat", Website = "https://ismoman.com", DisplayOrder = 1, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 2, SlNo = 2, Name = "Indian School Darsait", Code = "ISD", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Darsait", Website = "https://isdoman.com", DisplayOrder = 2, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 3, SlNo = 3, Name = "Indian School Al Wadi Al Kabir", Code = "ISWK", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Wadi Kabir", Website = "https://iswkoman.com", DisplayOrder = 3, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 4, SlNo = 4, Name = "Indian School Al Wadi Al Kabir International", Code = "ISWKi", Syllabus = "CAMBRIDGE", Classes = "KG I – IX & XI", Location = "Wadi Kabir", Website = "https://iswkoman.com", DisplayOrder = 4, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 5, SlNo = 5, Name = "Indian School Al Ghubra", Code = "ISG", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Al Ghubra", Website = "https://isgoman.com", DisplayOrder = 5, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 6, SlNo = 6, Name = "Indian School Al Ghubra International", Code = "ISGi", Syllabus = "CAMBRIDGE", Classes = "KG I – IX & XI", Location = "Al Ghubra", Website = "https://isgoman.com", DisplayOrder = 6, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 7, SlNo = 7, Name = "Indian School Bousher", Code = "ISB", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Bousher", Website = "https://isboman.com", DisplayOrder = 7, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 8, SlNo = 8, Name = "Indian School Seeb", Code = "ISAS", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Al Seeb", Website = "https://isseeoman.com", DisplayOrder = 8, IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalSchoolMaster { Id = 9, SlNo = 9, Name = "Indian School Maabela", Code = "ISAM", Syllabus = "CBSE", Classes = "KG I – IX & XI", Location = "Al Maabela", Website = "https://isamoman.com", DisplayOrder = 9, IsActive = true, IsDeleted = false, CreatedAt = seedDate }
            );

            // Seed Portal Guidelines Master
            modelBuilder.Entity<PortalGuidelineMaster>().HasData(
                new PortalGuidelineMaster { Id = 1, DisplayOrder = 1, Title = "Eligibility", Detail = "This online registration form is meant for Indian Nationals seeking new admissions in Indian Schools in the capital area for the academic year 2026-2027.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 2, DisplayOrder = 2, Title = "Single Mandatory Application", Detail = "Online registration is mandatory. There is only one application form required for one child; our system will not accept duplicate passport entries.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 3, DisplayOrder = 3, Title = "Credentials & Notifications", Detail = "A unique login registration number and password will be generated automatically upon submission and sent to your registered email and mobile number.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 4, DisplayOrder = 4, Title = "Application Processing Fee", Detail = "A non-refundable processing fee of OMR 15/- is payable upon successful submission of the application form.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 5, DisplayOrder = 5, Title = "Sibling Preference Rule", Detail = "Online application is mandatory even for sibling admissions. To claim sibling preference, the parent must select the sibling's school as their First Preference.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 6, DisplayOrder = 6, Title = "Seat Vacancies", Detail = "Tentative vacancies across different schools are dynamically updated on the portal for parents to review before submitting preferences.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 7, DisplayOrder = 7, Title = "Admission Allotment", Detail = "School allotment is strictly subject to vacancy availability and merit criteria set by the Board of Directors.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 8, DisplayOrder = 8, Title = "Help & Queries", Detail = "Parents are strongly advised to check the Frequently Asked Questions (FAQs) section for guidance on common registration questions.", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 9, DisplayOrder = 9, Title = "Inter-School Transfer", Detail = "Parents seeking inter-school transfer for their wards must complete the dedicated transfer portal:", Link = "https://forms.gle/P29avN2BoVufqWGz5", LinkText = "Inter-School Transfer Form", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
                new PortalGuidelineMaster { Id = 10, DisplayOrder = 10, Title = "Other Nationalities", Detail = "Parents of non-Indian nationalities seeking admission in Indian schools must apply through the external foreign quota portal:", Link = "https://forms.gle/hEUAnuLePfyTveD89", LinkText = "Other Nationalities Form", IsActive = true, IsDeleted = false, CreatedAt = seedDate }
            );

            // Seed Portal Configurations Master (Helpline, Email, Timings, Academic Year, etc.)
            modelBuilder.Entity<PortalConfigMaster>().HasData(
                new PortalConfigMaster { Id = 1, ConfigKey = "HelplinePhone", ConfigValue = "+968 2470 2567 / 2479 9700", Section = "CONTACT", Description = "Primary Admission Helpline Phone Numbers", IsActive = true, IsDeleted = false, CreatedAt = seedDate },
